...
var _siteSearchIntegration = __webpack_require__(5);
...
var _menuIntegration = __webpack_require__(4);
...
if (accordionElementExistsOnPage) {
  ...
  if (hash) {
    ...
    forEach(toggle, function (index, value) {
      ...
      var content = document.querySelector('[id="' + elementId + '"]');
...
var _stickybits = _interopRequireDefault(__webpack_require__(6));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// Hide the "In this section" navigation element if it's empty
if (!(0, _jquery.default)(".section-navigation-wrapper-inner-ul").length) {
  (0, _jquery.default)(".section-navigation").hide();
}
...
var _lightgallery = _interopRequireDefault(__webpack_require__(7));
...
var _gumshoe = _interopRequireDefault(__webpack_require__(22));

__webpack_require__(23);

var _smoothScroll = _interopRequireDefault(__webpack_require__(24));
...
if (elementExistsOnPage) {
  ...
  $('.anchor-links-title-link, .anchor-links-title-toggle').on('click', function (e) {
    e.preventDefault(); // because we don't want the page to jump around

    $('.anchor-links').toggleClass('active'); // $('.anchor-links-title-toggle-icon').toggleClass('uod-icons-menu');
...
(0, _jquery.default)('.search-result-filters input').change(function (event) {
...
(0, _jquery.default)(".in-page-search .search-input").keyup(function () {
  // Set the form id and search term (user input).
  var form_id = this.id,
      search_term = (0, _jquery.default)(this).val().toLowerCase(),
      results_holder = (0, _jquery.default)('#' + form_id).next('.tt-menu'),
      no_results_message = (0, _jquery.default)(this).closest('form').attr('data-attr-no-results-message'); // Set the search data 

  var search_list = courses; // Wait until the search term length is greater than two characters before starting the search.

  if (search_term.length > 2) {
    var results = search_data(form_id, search_term, search_list); // Make sure the results div is empty before adding new results.

    results_holder.children('.tt-dataset').html(''); // Show error message if no results have been found.
...
var _fuse = _interopRequireDefault(__webpack_require__(30));
...
var answer1 = "<h2>FDA OR FDSC</h2>" + "<ul>" + "<li>This study option is perfect for you if you do not want to commit to three uears of study as it is a two year programme</li>" + "<li>Provided you meet the entry requirements needed you can top up and study for a further year to achieve a full BA/BSc (Hons) degree" + "<li>Strong practical experience</li>" + "<li>Funding for this route of study is available through Student Finance</li>" + "<li>Course content is subject specific and so provides a strong knowledge base in preparation fo ryou transition from level 3 to level 4 study, if you choose to top-up</li>" + "</ul>";
var answer2 = "<h2>Access to higher education diploma</h2>" + "<ul>" + "<li>This study option is for you if you do not have the UCAS points required to begin a full BA/BSC (hons) degree</li>" + "<li>If you successfully complete, you will gain a nationally recognised Access to Higher Education Diploma</li>" + "<li>Once you've complete this course, you can apply to study on a degree of your choice</li>" + "<li>You will need to be over 19 years of age</li>" + "<li>Ideally, you will have achieved Mathematics and English Function Skills Level 2 or GCSEs at grade C (new grading 4), however students will be considered on an individual basis</li>" + "<li>If you are aged between 19-23, you may be exempt from course fees. For all other students you may be eligible to appply for the 19+ Advanced Learner Loan. Upon completion of your Access course and undergraduate degree, your Advanced Learner Loan will be written off.</li>" + "<li>We offer a pre-access course for developing academic skill and confidence - if you choose to complete this course, you will gain a nationally recognised Level 2 qualification which then enables you to apply for the Access to Higher Educaiton Diploma or Foundation Joint HOnours programme</li>" + "<li>On this course you will study a set of core subjects with no optional modules</li>" + "</ul>";
var answer3 = "<h2>Degree with foundation year</h2>" + "<ul>" + "<li>This study option is perfect for you if you achieve lower grades than expected, are returning to education for a change in career, or your a-levels no longer match your career ambitions and so want to build you knowledge in a different area</li>" + "<li>Our \"Degree with Foundation Year\" route is an integrated four-year degree. on completion of the four years, you will graduate with a full BA/BSc (Hons) dgree - you will not need to apply again for the remaining three years once you have complete the Foundation Year. If you course is arts-based, this is a stand-alone one-year course - you will have t re-apply directly to the University to graduate with a full BA/BSc (Hons) dgree</li>" + "<li>You can get funding for the for years of study</li>" + "<li>Couse content is subject specific and so provides a strong knowledge base in preparation for your transition from level 3 to level 4 study</li>" + "</ul>";
var answer4 = "<h2>Foundation programme joint honours</h2>" + "<ul>" + "<li>This study option is for you if you do not have the qualifications to study our Access to Higher Education Diploma</li>" + "<li>You will study three core subjects: Study Skills, Maths and English. You'll then choose a further three subjects from a set subject list</li>" + "<li> We offer a pre-access course for developing academic skills and confidence - if you choose to complete this course you will gain a nationally recognised Level 2 qualification which then enables you to apply for the Access to Higher Education Diploma or Foundation Joint Honours programme.</li>" + "<li>If you're eligible, funding for this course can be granted through the Student Loans Company</li>" + "</ul>";
var questions = {
  entry: "question1",
  question1: {
...
function renderQuestion(question) {
  ...
  (0, _jquery.default)(quizContainer).append(questionObject.text);
...
function makeGoBackButton() {
  ...
  backNode.onclick = function (event) {
    event.preventDefault();
    getLastQuestion(questionHistory.pop());
  };
...
function makeAnswer(answer, question) {
  ...
  answerNode.onclick = function (event) {
    event.preventDefault();
...
if ((0, _jquery.default)("#quizContainer").length) {
  doQuiz();
}
...
var _masonryLayout = _interopRequireDefault(__webpack_require__(33));

var _imagesloaded = _interopRequireDefault(__webpack_require__(38));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

if ((0, _jquery.default)('.teaser-listing-container').length > 0) {
  var loaderMarkup = '<div class="teaser-loader"><div class="spinner"></div></div>';

  (function () {
    (0, _jquery.default)('.teaser-listing-container').prepend(loaderMarkup);
  })();

  var msnry = new _masonryLayout.default('.teaser-listing', {
    // options
  ...
  (0, _imagesloaded.default)(document.querySelector('.teaser-listing'), function (instance) {
    msnry.layout();
  });
  msnry.on('layoutComplete', function () {
    setTimeout(function () {
      (0, _jquery.default)('.teaser-loader').fadeOut(1000, function () {
...
var _objectFitVideos = _interopRequireDefault(__webpack_require__(41));
...
var _youtubePlayer = _interopRequireDefault(__webpack_require__(43));
...
if ((0, _jquery.default)('.tv').length && !!self.vid === true) {
  ...
  if ((0, _jquery.default)('.tv').is(":visible")) {
...
function vidRescale() {
  var w = (0, _jquery.default)('.video-hero').first().width() + 200,
      h = (0, _jquery.default)('.video-hero').first().height() + 200;

  if (w / h > 16 / 9) {
    tv.setSize(w, w / 16 * 9);
    (0, _jquery.default)('.tv .screen').css({
      'left': '0px'
    });
  } else {
    tv.setSize(h / 9 * 16, h);
    (0, _jquery.default)('.tv .screen').css({
      'left': -((0, _jquery.default)('.tv .screen').outerWidth() - w) / 2
    });
  }
}
...
var _sister = __webpack_require__(44);

var _sister2 = _interopRequireDefault(_sister);

var _loadYouTubeIframeApi = __webpack_require__(45);

var _loadYouTubeIframeApi2 = _interopRequireDefault(_loadYouTubeIframeApi);

var _YouTubePlayer = __webpack_require__(47);
...
var _loadScript = __webpack_require__(46);
...
var _debug = __webpack_require__(48);

var _debug2 = _interopRequireDefault(_debug);

var _functionNames = __webpack_require__(52);

var _functionNames2 = _interopRequireDefault(_functionNames);

var _eventNames = __webpack_require__(53);

var _eventNames2 = _interopRequireDefault(_eventNames);

var _FunctionStateMap = __webpack_require__(54);
...
var _PlayerStates = __webpack_require__(55);
...
$('#apply-online-form').submit(function (e) {
  ...
  var sectionId = $('.apply-online-course-select:visible option:selected').val(),
      ...
      url = 'https://registration.derby.ac.uk/psp/HPRDOLA2/EMPLOYEE/EMPL/h/?tab=UD_OLA_COURSE_SELECTION&PGR=' + programCode; // if the program code doesn't contain a comma or a pipe we can go straight to the portal...
...
$('#select-1, #select-2').on('change', function () {
  ...
  var subjectLinks = ""; // We need to get each table individually so we can swap out required and optional items
  ...
  if ($('#select-1').val()) {
    ...
    $('#comparison-1').empty().append(subject1Heading).append(compulsoryIntro).append($(subject1Tables[0]).clone()).append(optionalIntro).append($(subject1Tables[1]).clone());
  }
  ...
  if ($('#select-2').val()) {
    ...
    $('#comparison-2').empty().append(subject2Heading).append(compulsoryIntro.clone()).append($(subject2Tables[0]).clone()).append(optionalIntro.clone()).append($(subject2Tables[1]).clone());
  }
...
$(document).ready(function () {
  $('table:not(.cal-table)').each(function () {
    var table = $(this);
...
(function () {
  if ($(".pagination-controls").length === 0) {
    var items = $("[data-position]").filter(function () {
      if (parseInt($(this).data("position")) > 0) {
        return $(this);
      }
    });
    var container = $(document.createElement('div'));
    $(container).addClass("search-result-wrapper-container");
    $('.search-result-wrapper').first().before(container);
