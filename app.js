...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! lg-video - v1.3.0 - 2020-05-03
* http://sachinchoolur.github.io/lightGallery
* Copyright (c) 2020 Sachin N; Licensed GPLv3 */
...
var _siteSearchIntegration = __webpack_require__(7);
...
var _menuIntegration = __webpack_require__(6);
...
var _houdini = _interopRequireDefault(__webpack_require__(17));
...
var _gumshoejs = _interopRequireDefault(__webpack_require__(22));
...
if (elementExistsOnPage) {
  ...
  var spy = new _gumshoejs.default('ul[data-gumshoe-header]', {
    offset: 40,
...
if (!(0, _jquery.default)('.not-main-search').length) {
...
var _fuse = _interopRequireDefault(__webpack_require__(9));
...
document.addEventListener('initchosen', function () {
  var subjectSelect = (0, _jquery.default)('#subject').chosen();
...
var _loop = function _loop(i) {
  var owlClass = "owl-carousel-".concat(i);
  var navId = "nextSlide-".concat(i);
  var navButton = "<a href=\"\" id=\"".concat(navId, "\" class=\"carousel-control\"><i class=\"uod-icons uod-icons-chevron-right\"></i></a>");
...
(function () {
  if ($(".pagination-controls").length === 0 && $(".search-result-wrapper[data-position]").length !== 0) {
