 ...
 */
 class Visualiser {
  ...
  constructor(target, options = {}) {
      ...
      // Audio controls
      this.controls             = this.visualiser.querySelector('.audio-controls');
      this.volumeContainer      = this.visualiser.querySelector('.volume');
  ...
  buildVolume() {
    ...
    volumeControl.addEventListener('keyup', () => {
      this.audio.volume = volumeControl.value;
    });
    volumeLabel.appendChild(volumeControl);
  
    this.volumeContainer.appendChild(volumeLabel);
  }
}
...
vis = new Visualiser(targetVisualiser);
})